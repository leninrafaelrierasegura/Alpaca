...
Data is downloaded daily from [here](https://www.nasdaq.com/market-activity/stocks/screener).
...
datatable(
  ...
  escape = FALSE,
  rownames = FALSE,
  class = "display nowrap"  # Apply no-wrap class here to prevent wrapping of text in cells
)
...
```{r}
print("It will automatically execute!")
